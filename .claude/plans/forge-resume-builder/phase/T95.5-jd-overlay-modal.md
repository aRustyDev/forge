...
> **Status:** ✓ Complete — merged to main (2026-04-05). Design spec at `d1f25de`.
> Implementation shipped across commits `d419c3d` (store), `4383142` +
> `78d8e63` + `6b9dbb8` + `c913dd1` (modal primitive + fixes), `c053f23`
> (host), `fb99df8` (barrel), `b240f61` (README), `709b791` (tests),
> `e383cff` (layout mount), and `2fdbe20` (ResumeLinkedJDs wiring).
> Feature branch rebased and fast-forward-merged as `a59210b`.
>
> **Beads:** `job-hunting-x03.5` — CLOSED.
